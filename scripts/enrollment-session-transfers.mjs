...
const root = path.resolve('.tmp/enrollment-session-transfers');
...
const version = '20260909000500_enrollment_session_transfers';
const file = `supabase/migrations/${version}.sql`, checksum = textFileSha256(file);
const assertionsFile = 'scripts/sql/enrollment-session-transfers-assertions.sql';
...
const statement = `begin;set local lock_timeout='5s';set local statement_timeout='90s';
  select pg_advisory_xact_lock(hashtextextended('enrollment-session-transfers',0));
