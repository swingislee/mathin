...
状态：**本地修复及定向验证完成，开发端可验收；尚未发布生产**。本次生产操作仅读取应用日志、release 元数据、服务状态与健康接口。

## 故障依据

- 生产 current 为 `20260909-042441` / `c63a47b5b0d5031ea3c34cd934fbf6307abd37b0`；服务 active，`NRestarts=0`，健康接口正常。
