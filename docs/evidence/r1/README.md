...
- [2026-09-11 课堂学情页边提醒开发交付](classroom-learning-reminder-edge-development-20260911.md)：实际课堂增加站点玫瑰红细框与书签，沿用原登记进度与完成态；已修复试讲空配置引起全页误提醒，相关检查通过，使用真实课次验收，生产未切换。

- [2026-09-11 课堂学情登记提醒](classroom-learning-reminder-production-20260911.md)：方案 C 的登记入口高亮、页级保存进度与完成态已实现；定向检查与生产构建通过，生产切换因自动审批要求直接确认而待执行，待人工课堂验收。
