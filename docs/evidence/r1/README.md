...
| 阶段 | 状态 | 日期 | 证据 |
| --- | --- | --- | --- |
| 课堂体验升级 M0–M5 | Stage A/B1/B2 passed；Stage B3 stopped/fail-closed rollback | 2026-08-26 | [开发端验收摘要](classroom-experience-dev.md)与[M5 生产分段启用](classroom-experience-m5-candidate.md)：候选 `8c303a2` 已发布，`20260825000700` 与新鲜 PostgreSQL pre-change 备份已核验。产品负责人确认 B1/B2 通过，生产 checkpoint version/chunk/head=`2/2/2`；board/input/layout 为 version 2 / true，H5 因实际 399 个页面均走未接 bridge 的 Aixuexi 舞台而回退为 version 3 / false，等待开发补齐 |
