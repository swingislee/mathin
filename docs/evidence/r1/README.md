...
- [2026-09-11 多人活动安排推定关联](base-activity-source-links-development-20260911.md)：剩余一条多人安排拆为四段，各自匹配现有线索档案，沿用“资料关联待核对”标签。范围、回滚、原文与实际档案读取检查通过，开发端已交付待人工验收，生产未写入。

- [2026-09-11 Base 待确认第三轮整理](base-review-resolution-development-20260911.md)：按确认规则完成错填归位和同格拆分，345 项待确认降至 1 项；159 个字段标为“资料待补”，5 组家庭来源保存 10 份子女资料。版本、权限、回滚、逐字段再读和中英文页面检查通过，开发端已交付待人工验收，生产未写入。
