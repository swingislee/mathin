...
- [2026-09-15 教学周／月／学期查看](teaching-period-development-20260915.md)：总览式时间控件、当前／上一期快捷入口、真实学期日期与带时间范围的详情读取；本地查询范围和定向检查通过。页面待人工验收，扩大生产快照的导出待明确范围确认。

- [2026-09-15 纸质作业逐题登记](homework-question-entry-development-20260915.md)：沿用课堂六档学情，按学生或按题登记，批量填充、备注、撤销及教学详情矩阵；本地数据库、权限、版本冲突和持久再读检查通过。开发端待人工验收，学生在线逐题入口待后续接入，生产未部署。

- [2026-09-15 三位老师上周教学记录与分组](teaching-production-replay-20260915.md)：加入薛立志，当前快照包含 12 班、12 课次、226 条学情；首个标签为全部老师，支持按档案年级或实际任课老师分组，组内原位展开。开发端可验收，生产只读提取，未写入或部署。
