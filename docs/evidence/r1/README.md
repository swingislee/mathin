...
- [2026-09-22 数据总览汇总接入](overview-summary-integration-20260922.md)：获客/沟通共用数据库候选，SQL 667–679 ms 降至 325–328 ms；页面内部 33 次/8.62 MB 降至 27 次/3.21 MB，读取 421–469 ms。六角色 SQL 及 16 组完整页面数据对照通过，开发已生效、生产未发布；首次开发响应仍为 2.849 s，整页 1 秒待验收。
