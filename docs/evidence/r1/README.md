...
| 阶段 | 状态 | 日期 | 证据 |
| --- | --- | --- | --- |
| 课堂体验开发线 M0–M5 local | local integration candidate passed；production write pending authorization | 2026-08-25 | [开发端验收摘要](classroom-experience-dev.md)与[M5 本地集成候选](classroom-experience-m5-candidate.md)：产品负责人以 `95ed9f1` 确认 M0–M4，候选 `8c303a2` 通过工程、隔离数据库和本地浏览器 Gate；Xiaomi 仅完成只读 preflight，未发布、未迁移 `20260825000700`、未启用四个课堂开关 |
