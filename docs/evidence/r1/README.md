...
| R1-Live | Gate 1 passed；Gate 2 single-teacher production trial/blocking；课堂 B3 remediation、phone/password P0、账号中心第一阶段、教师微课多方案与来源课件运行时 pending acceptance | 2026-08-28 | [真实教师点名闭环差距表、手机号 P0、账号中心与课堂发布证据](r1-live.md)；[目标核查、应用/数据库发布、正式管理员交接、manifest 激活、真实教师注册/岗位保护、当前生产备份及 2026-08-25 环境误判事件](r1-live-target-audit.md)；[教师微课与多方案生产证据](teacher-microcourse-dev.md)；[来源课件运行时与暑期 A+ 生产证据](courseware-source-runtime-production.md)；[仓库写入目标保险丝](../../runbooks/r1-write-target-policy.md)；[正式对象保护 manifest](../../runbooks/r1-live-object-protection-manifest.md)。生产 current/previous=`20260828-071313` / `087b497…` 与 `20260828-071024` / `087b497…`，ledger=`211`、head=`20260828000200_courseware_summer_a_plus_catalog`；课堂 B1/B2 已人工通过，B3 修复底座已部署但 H5 flag 仍 false。教师微课多方案与来源课件运行时是独立开发轨，已发布但不关闭 R1-Live Gate 2。正式账号与既有班课对象无漂移；课堂 B3、账号中心、教师微课生产写态、来源课件产品验收、真实手机号邀请注册/login 及正式教师点名保存/再读与权限对照仍待人工闭环 |
