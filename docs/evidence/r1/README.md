...
- [2026-09-14 学生再联系读取性能](student-recontact-read-performance-20260914.md)：独立候选 `1ad14a81` 已完成开发验证及生产只读 preflight，待生产授权；16 项完整结果、账号状态与回滚检查通过。开发未接通完整页面约 1.1 秒、沉默约 2.5 秒，异常等待记录与定向复测分别保留。

- [2026-09-14 学生与学服子路由性能](school-route-performance-20260914.md)：第二条补丁已部署，账本 384；生产管理员当前线索约 1.63 秒降至 95 毫秒，18 项完整读取与发布检查通过。再联系分组的第三条补丁已在开发验证，待生产授权。

- [2026-09-14 Base 大屏与生产总览复核](base-dashboard-reconciliation-20260914.md)：8、9 月来源集合和人员小计只读复算；9 月到访 41、测评 41、报名 14 对齐，诺访 60／62；获客旧文件入口遗漏 17 条可计数的新来源，秋季在读 159／161。差异已定位，生产尚未修正。
