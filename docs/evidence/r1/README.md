...
- [2026-09-14 管理员总览加载回退修复](dashboard-collaboration-read-regression-20260914.md)：定位生产后补协作迁移覆盖性能策略；恢复兼容协作的读取路径，48 项固定身份读取对照及回滚检查通过，开发完整 HTTP 约 1.5 秒，待本次生产迁移授权。
