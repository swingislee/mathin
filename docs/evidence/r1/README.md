...
- [2026-09-15 大屏首次加载与学科运营响应](dashboard-cold-start-20260915.md)：独立候选 `2ded3c75` 包含前轮传输补丁和本轮路由加载、静态消息与统计并行修复；本机 Linux 三次首次大屏为 1.43–1.49 秒，8 组完整数据对照一致，生产可操作时间待发布后验收。等待应用与配置发布授权。
