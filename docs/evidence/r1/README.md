...
- [2026-09-14 学生再联系读取性能](student-recontact-read-performance-20260914.md)：生产再联系四组约 11–16 秒；减少重复权限和混合关联，开发管理员未接通约 3.31 秒降至 551 毫秒，16 项完整结果、账号状态与回滚检查通过，待生产授权。

- [2026-09-14 学生与学服子路由性能](school-route-performance-20260914.md)：第二条补丁已部署，账本 384；生产管理员当前线索约 1.63 秒降至 95 毫秒，18 项完整读取与发布检查通过。再联系分组另有约 11–16 秒的重复权限读取，正在优化。
