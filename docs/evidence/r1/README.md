...
- [2026-09-15 学生与学服读取深度修复](student-list-deep-read-20260915.md)：批量协作读取、再联系数据库分页、同组及未分配超时修复，报名／续报省去未使用的来源传输。独立候选 `58ebc8b4` 已通过构建、完整数据与路由检查；开发已交付，本批两条迁移及应用尚未发布生产，待授权和人工验收。
