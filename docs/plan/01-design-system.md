...
学辅表格的强调方案以 [共用跟进面板合同 §6](school-support-followup-panel-contract.md#6-表格强调方案设计依据与笔记本布局) 为本次目标：后续反馈已修正此前“选中、展开及详情共用蓝色填充”的方案，新的状态区分、浅黄表面和深黄轮廓尚待实现及人工视觉验收。该专题约定作用于本轮学辅工作区，不据此批量更改其他专业页面。
