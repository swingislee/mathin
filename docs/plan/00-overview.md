...
> **2026-09-19 开发端工作入口更新**：按产品负责人要求，日常工作上升为线索、沟通、测评、学生、班级、续班一级入口，课表紧随总览，学年归入组织管理。学生五标签保留，沟通内嵌首联，班级整合分班与教学登记；旧入口退役。开发端已交付、待人工验收，实施范围见[仪表盘工作入口重组](dashboard-work-entry-restructure.md)，不改变生产事实或 Gate 状态。
