...
>
> **当前未结项**：R1-8 已按安全关闭路径关闭；财务发布门固定关闭，路由/导航、数据、work item/审批、通知、指标和 job 均无可操作入口。当前进入 R1-9，校验 71 篇中文 Terms 与公共内容发布链，并验证 E 系列 865 讲及爱学习 G+ 秋季 52 讲的 16:9/4:3 双轨 release 资源。
>
> **核对日期**：2026-08-03；依据代码、迁移、内容目录、CI、Git、R1-6 教学成果链路、R1-7 导出链路、R1-8 财务安全关闭证据、R1-9 爱学习课程支持证据与 doc 00～26。
...
| E 系列开发数据有 865 讲双轨资源；爱学习 G+ 秋季有三至六年级 52 讲双轨资源 | R1-9 分别验证两套文档合同与资源；R1-15 演练；R1-18 重建 1834 条正式 release-1 |
| 课程目录版本层已落库（2026-08-03，迁移 `20260803000300`/`20260803000400`）：E 系列 2026新版 18 门、2025旧版 54 门，讲次仍为 865 | 2026 秋季来源包 270 讲尚未导入；导入是独立任务，完成时按 doc 25 §5.1.1 同步 seed、manifest、doc 00/04/25 与迁移断言 |
...
| 阶段 | 依赖 | 动作与产物 | 退出证据 |
| --- | --- | --- | --- |
| **R1-9 Terms 与内容发布链/P6-9** | R1-1～3、R1-7 | 校验 71 篇中文 Terms 的 slug、公式、依赖、引用、搜索、SEO；建立公共内容 draft/review/publish/withdraw/revise；验证 E 系列 865 讲和爱学习 G+ 秋季 52 讲的两轨文档、binding、对象和不可变 release | Terms 坏链/悬空关系=0；英文缺失回退明确；E 系列 865×2 与爱学习 52×2 资源 manifest 完整且重复生成 hash 相同 |
