...
| 当前全量 Vitest 共 87 个测试文件、565 项；其中非 spatial 基线为 51 个文件、290/290，空间数学/SML-0 专项为 36 个文件、275/275，`pnpm r1:test` 既有基线为 18 个文件、121/121 | SML-0 与 R1-14 均保持全量 100% 通过；正式 Playwright 框架已有本地基线，仍须补发布目标、写态、zh/en、跨浏览器、连续无 flaky、并发、文件和竞争矩阵 |
