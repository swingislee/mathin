...
| 当前全量 Vitest 共 74 个测试文件、464 项，commit `cbb2a0f` 已将本轮修复前 19 项失败清零；其中非 spatial 基线为 51 个文件、290/290，空间数学/Tools 样机专项为 23 个文件、174/174，`pnpm r1:test` 为 18 个文件、121/121 | R1-14 保持全量 100% 通过；正式 Playwright 框架已有本地基线，仍须补发布目标、写态、zh/en、跨浏览器、连续无 flaky、并发、文件和竞争矩阵 |
