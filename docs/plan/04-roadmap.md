...
>
> **当前未结项**：R1-8 已按安全关闭路径关闭；财务发布门固定关闭，路由/导航、数据、work item/审批、通知、指标和 job 均无可操作入口。当前进入 R1-9，校验 71 篇中文 Terms 与公共内容发布链，并验证 865 讲的 16:9/4:3 双轨 release 资源。
>
> **核对日期**：2026-08-01；依据代码、迁移、内容目录、CI、Git、R1-6 教学成果链路、R1-7 导出链路、R1-8 财务安全关闭证据与 doc 00～26。
