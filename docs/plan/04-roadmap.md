...
## P4H 教学运营体验重构（2026-07-19 立项；2026-07-20 按 P6-8 后真实页面修订；执行计划见 `18-p4h-teaching-operations-experience.md`）
...
排期约束：P6-8 已完成，P4H 现在可启动并严格按 0→11 串行；P4H-3 完成后可执行 P6-9 全量数据导入，P6-9 的“865 讲可浏览”最终验收必须等待 P4H-5/6 并使用新入口。每条任务一次独立提交，验收细节、文件范围、错误码与停止条件以 doc 18 为准。
