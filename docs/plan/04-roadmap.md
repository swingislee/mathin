...
- 课堂体验升级 M0–M4 已于 2026-08-25 在本机开发目标完成产品负责人整体验收，已验收应用基线为 `95ed9f1`；输入路由、白板恢复、H5 bridge、稳定名单/星星 v2、教师布局和逐题学情均转入 M5 生产候选 Gate。该结论不表示 Xiaomi 应用已部署、课堂开关已启用或 Gate 2 已通过，生产迁移、发布和启用仍需精确 preflight 与本次明确授权。
