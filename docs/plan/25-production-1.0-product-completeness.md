...
| 机构配置/场地/Feature Flag | M3 | M4 | R1-1 已完成旧设置中心与版本化开关；`DEV-ORG-1` 已在本机完成机构资料、校区/教室目录、机构级学年/日历/排课默认和系统能力发布拆分，兼容双写及固定管理员旅程 1/1 通过。M4 仍需开发人工验收、生产初始化、正式角色旅程和发布门 | 1/DEV-ORG-1/15/18 |
