...
> **规划状态**：`complete`
>
> **当前用途**：P4B 学校数据底座与历史业务规则参考。
>
> **权威边界**：历史 UI/角色描述已被 P4H/P4I 和当前数据库角色模型覆盖；本文“无 campuses 表”已被 doc 25 §4.3 与 R1-1 替代，当前为单机构、多校区，仍不支持多租户。
>
> **剩余项**：不重开 P4B；生产闭环缺口统一进入 doc 25。
>
> **最后核对**：2026-07-28。
