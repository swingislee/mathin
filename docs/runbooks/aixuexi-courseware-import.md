...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `2026-gplus-sujiao-math` | G+ / 苏教版 | 3～6 | 4 | 56 | 1641 | 3、4年级共 4 讲 |
| `2026-xplus-sujiao-math` | X+ / 苏教版 | 1～6 | 6 | 84 | 2767 | 1、3、4年级共 6 讲 |
...
开发库另可导入暑期增量包 `2026-summer-aplus-quanguo-math`。该包当前只包含1年级 A+ 全国版第 1 讲《一个萝卜一个坑》和第 8 讲《逃家的小羊》，合计 2 讲、66 页；数据库课程保留完整 15 讲教学计划，其余 13 讲只建空 `courseware_template`、无 release 的占位讲次，不补造课件或来源记录。这个开发增量不改变上表 Production 1.0 秋季基线。
