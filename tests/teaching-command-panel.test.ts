...
describe("teaching records shared command panel", () => {
  ...
  it("wires live and replay routes to the shared panel and preserves the selected time grain", () => {
    const live = readFileSync("src/app/[locale]/dashboard/teaching/page.tsx", "utf8");
    const replay = readFileSync("src/app/[locale]/dashboard/teaching/review/page.tsx", "utf8");
    ...
    expect(live).toContain('progressHref(selection, period, "records")');
