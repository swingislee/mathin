...
describe("formal cube composition pages", () => {
  ...
  it("keeps toolbar configuration strict and excludes private pointers, generic tools and legacy versions", () => {
    expect(toolCoursewareContractsForSurface("formal-courseware").map((contract) => contract.contentVersion)).toEqual(["cube-structures-lesson-v2", "cube-net-lesson-v1", "dice-lesson-v1"]);
