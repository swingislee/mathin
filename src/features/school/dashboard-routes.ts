...
export const DASHBOARD_ROUTES = {
  ...
  microcourseReviews: {
    href: "/dashboard/courseware/microcourse-reviews",
    kind: "queue",
    environments: STAFF_ONLY,
    permission: "courseware.review",
    createSurface: "none",
    parent: "courseware",
    nav: { labelKey: "microcourseReview", group: "research" },
  },
  microcourseReviewDetail: {
    ...
    permission: "courseware.review",
    createSurface: "parent",
    creationOwner: "microcourseReviews",
    parent: "microcourseReviews",
  },
  legacyMicrocourseReviewDetail: {
