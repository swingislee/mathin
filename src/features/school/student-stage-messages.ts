...
export function studentStageMessages(locale: string) {
  ...
  return {
    ...
    searchHint: en ? "Search covers all accessible records and stages within the selected view." : "搜索覆盖所选查看范围内的全部档案和业务阶段，可直接打开原有经历。",
    ...
    mine: en ? "I participated" : "我参与的", all: en ? "All accessible" : "全部可见", unassigned: en ? "Unassigned" : "未分配学服",
    ...
    needOwner: en ? "You can view this record. A manager can add you as a participant when you take part in its work." : "当前可查看此档案；参与办理时，管理员或主管可将你加入参与人。",
    needOwnerAssignment: en ? "Learning support: {name}. You can view this record; editing requires participation and the relevant job permissions." : "学服：{name}。当前可查看此档案，编辑需要相应的参与经历和岗位权限。",
