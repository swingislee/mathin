...
export function studentStageMessages(locale: string) {
  ...
  return {
    ...
    needOwner: en ? "Assign learning support in this list before contacting." : "先在本名单分配学服，再登记首联。",
    needOwnerAccount: en ? "Source learning support: {name}. Link the staff account that will handle this record to continue." : "原表学服：{name}。关联实际办理的学服账号后，可继续登记。",
