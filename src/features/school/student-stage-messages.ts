...
export function studentStageMessages(locale: string) {
  ...
  return {
    ...
    assign: en ? "Assign" : "分配", chooseOwner: en ? "Choose an owner" : "选择负责人", assigned: en ? "Assignment saved" : "负责人已分配",
    ...
    assignmentConflict: en ? "The owner or student profile changed. Refresh the list before assigning." : "负责人或学生档案已有变化，请刷新名单后分配。",
    assigneeUnavailable: en ? "This staff member cannot receive follow-ups. Choose another owner." : "该员工暂时不能接收跟进，请重新选择负责人。",
    ...
    needOwner: en ? "Assign an owner in this list before contacting." : "先在本名单分配负责人，再登记首联。",
