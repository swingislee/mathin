...
import { studentRecordTableStage, type StudentStageFilters } from "./student-stage-contract";
...
export async function loadStudentStageFieldPage(filters: StudentStageFilters, context: DashboardDateContext, currentUserId: string) {
  ...
  return { ...result, counts: source.counts, reasonCounts: source.reasonCounts };
}
