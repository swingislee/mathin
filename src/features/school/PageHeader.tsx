 ...
 */
export async function SchoolPageHeader({
  title,
  eyebrow,
  actions,
  children,
  ...
  const t = breadcrumbs && breadcrumbs.length > 0 ? await getTranslations("common") : null;
  return (
    <header className="flex flex-wrap items-end justify-between gap-3 border-b border-line pb-4">
      <div className="min-w-0">
        ...
        {breadcrumbs && breadcrumbs.length > 0 && (
          <Breadcrumb ariaLabel={t!("breadcrumbNav")} className="mb-2">
            <BreadcrumbList>
