...
export function businessRecordMessages(locale: string) {
  return locale==='zh'?{
    ...
    viewStudent:'查看学生档案',outcomeUnknown:'最终结果未记录',period:'学期',registeredOn:'报名日期',
    recordedOnly:'历史事实',historyCount:'历史记录',search:'搜索学生、活动或记录',
  }:{
    ...
    viewStudent:'Student profile',outcomeUnknown:'Final outcome not recorded',period:'Term',registeredOn:'Registered on',
    recordedOnly:'Historical fact',historyCount:'Historical records',search:'Search student, activity or record',
  };
}
