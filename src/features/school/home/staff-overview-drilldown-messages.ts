const zh = {
  ...
  conversionNote: "转化率 = 本期报名人数 ÷ 本期参与人数。来源报名按报名月份统计，可包含此前参与的学员；切换“参与后报名”查看完整报名名单。",
...
const en: Record<keyof typeof zh, string> = {
  ...
  conversionNote: "Conversion = enrollments in this period ÷ participants in this period. Source enrollments use the enrollment month and may include earlier participants. Select Enrollment after participation for the complete enrollment list.",
