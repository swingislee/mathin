  ...
  const entryCell = (
      <TableCell className="px-2 py-2">
        ...
        <div className="flex min-w-0 items-center gap-1">
          ...
          {detailsOpen ? <span className="min-w-0 flex-1 text-xs text-muted">{entryT(note.trim() ? "draftExpanded" : "noteExpanded")}</span> : <Input value={note} disabled={!canUseEntry || pending} maxLength={2000} className="h-8 w-0 min-w-0 flex-1 px-2 text-xs"
