  ...
  return <>
    <div className="print:hidden">
      <div className="mb-4 flex flex-wrap items-center gap-2 border-y border-line bg-card px-3 py-3">
        <Link href={`/dashboard/activities/${data.activity.id}?view=print`} className={buttonVariants({ variant: "ghost", size: "sm" })}><ArrowLeft className="size-4" />{t("backToPrint")}</Link>
