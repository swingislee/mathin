...
export function FollowupPersonCell({ name, phone, grade, owner, selection, expanded, detailsId, onToggle, subject, studentGrade, nameOnly = false, inlineGrade = false }: {
  name: string; phone: string; grade: string; owner?: string; selection?: ReactNode;
  expanded: boolean; detailsId: string; onToggle: () => void;
  subject: Student360SubjectRef; studentGrade?: number | null; nameOnly?: boolean; inlineGrade?: boolean;
}) {
