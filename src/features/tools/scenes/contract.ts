...
import { somaToolSchema } from "../soma-cube/contract";
...
export const toolSceneSchema = z.discriminatedUnion("contentVersion", [cubeCoursewareV2ToolSchema, cubeCoursewareV3ToolSchema, ...spatialTeachingToolSchema.options, ...numericTeachingToolSchema.options, projectionToolSchema, solidGeometryToolSchema, netTeachingToolSchema, solidCapacityToolSchema, somaToolSchema]);
