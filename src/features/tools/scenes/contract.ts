...
export const toolSceneSchema = z.discriminatedUnion("contentVersion", [cubeCoursewareV2ToolSchema, ...spatialTeachingToolSchema.options, ...numericTeachingToolSchema.options]);
