...
const zh = {
  ...
  cutHint: "两线确定截面，或用面朝向选择层界。确认后在截面旁点击切割。选线时左键用于选择；可用视图按钮，或切到观察旋转后继续，已选线会保留。",
  cutInput: "截面选择方式", cutEdge: "两条线定截面", cutFace: "选面朝向", cutEdgeHint: "依次选两条不同的共面棱线，例如前面一条竖线，再选顶部与它相交的线。两线成立后才预览完整截面。0% 透明面允许穿透，仍可选可见棱边。", cutFaceHint: "点击完整可见面，以其法向选择内侧最近层界；选中后可微调层界。",
  cutFirstLine: "第 1 步：选择第一条棱线。", cutSecondLine: "第 2 步：第一条已保留，再选一条与它共同确定截面的线。", cutReady: "截面已确定，可确认切割或重新选择。",
  cutSecondReady: "两线可确定此截面，点击第二条线锁定。",
  cutRestart: "重新选择", cutUseScope: "清除临时选择，使用当前组／整体", cutHidden: "含隐藏块",
  cutIssues: {
    miss: "这里没有可见候选。请靠近棱线；选面模式可点击完整表面。",
    scope: "命中对象不在当前切割范围。请调整分组，或清除临时选择。",
    collinear: "这两段属于同一条直线。第一条已保留，请选另一条不共线的线。",
    skew: "这两条线不共面。第一条已保留，请选与它相交或平行的共面线。",
    oblique: "两线确定的是斜截面。当前支持 XYZ 层间切割，请换一条线。",
    boundary: "两线定出的平面未穿过层间，两侧无法分开。请换到另一可见面选第二条线。",
    displaced: "当前范围在此方向已有不同展示位移。请选择一个分组，或合拢后再确定截面。",
...
const en = {
  ...
  cutHint: "Define a section with two lines, or pick a face direction. Confirm with Cut beside the section. Left-click selects; use view buttons or switch to Observe and back to rotate. Selected lines are retained.",
  cutInput: "Section selection", cutEdge: "Two lines define a section", cutFace: "Pick face direction", cutEdgeHint: "Pick two distinct coplanar edges: for example, a vertical front edge and an intersecting top edge. The full section appears only after both define it. 0% faces allow picking through; visible edges remain selectable.", cutFaceHint: "Click anywhere on a visible face to choose the nearest inward layer boundary parallel to it. Fine-tune the boundary after locking.",
  cutFirstLine: "Step 1: Pick the first edge.", cutSecondLine: "Step 2: First line retained. Pick another line that defines a section with it.", cutReady: "Section ready. Confirm the cut or choose again.",
  cutSecondReady: "These lines define this section. Click the second line to lock it.",
  cutRestart: "Choose again", cutUseScope: "Clear selection and use the group / whole structure", cutHidden: "Hidden cubes included:",
  cutIssues: {
    miss: "No visible candidate here. Move closer to an edge, or click a surface in face mode.",
    scope: "This object is outside the cutting scope. Change the group or clear the temporary selection.",
    ...
    boundary: "This plane does not separate layers. Choose the second line on another visible face.",
    displaced: "This scope has different display offsets along that direction. Select one group or reassemble first.",
