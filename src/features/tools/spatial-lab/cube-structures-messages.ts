...
const zh = {
  ...
  cutHint: "指向方块的面预览截面，面朝向自动确定 XYZ。点击锁定后，在截面旁选择切割或取消；切开后可继续操作移开组。",
  cutConfirm: "切割",
...
const en = {
  ...
  cutHint: "Hover over a face to preview a section; the face sets the XYZ direction. Click to lock it, then choose Cut or Cancel beside the section. Continue with the separated group.",
  cutConfirm: "Cut",
