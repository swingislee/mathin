const zh = {
  ...
  hint: "选择方向，再调整平移和倾斜。移去一侧可观察内部；切换方向不会改变相机。",
...
const en: typeof zh = {
  ...
  hint: "Choose a direction, then slide or tilt the plane. Remove either side to look inside; the camera stays in place.",
