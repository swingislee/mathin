...
/**
 * Standards-compatible SHA-256 used when Web Crypto is unavailable, such as
 * an HTTP classroom LAN origin. It preserves scene/replay hashes exactly.
 */
export function sha256BytesFallback(bytes: Uint8Array): string {
...
export async function canonicalSha256(value: unknown): Promise<string> {
  ...
  if (!subtle) return sha256BytesFallback(bytes);
