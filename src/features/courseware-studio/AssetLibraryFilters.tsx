...
export function AssetLibraryFilters({ initial }: Props) {
  ...
  return (
    <form onSubmit={submit} className="mt-6 grid gap-3 rounded-2xl border border-line bg-card p-4 md:grid-cols-[minmax(12rem,1fr)_10rem_10rem_8rem_auto] md:items-end">
