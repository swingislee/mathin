    ...
    <main data-planet="geographer" className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto flex w-full max-w-xl flex-1 flex-col items-center justify-center px-6 pb-24 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link href="/terms" className="rounded-full border border-crater bg-card px-4 py-2 text-sm transition duration-200 hover:-translate-y-0.5 hover:bg-moon/40">
            {t("browseTerms")}
          </Link>
          <Link href="/" className="rounded-full border border-line px-4 py-2 text-sm text-muted transition duration-200 hover:-translate-y-0.5 hover:text-ink">
            {common("backHome")}
          </Link>
        </div>
      </div>
