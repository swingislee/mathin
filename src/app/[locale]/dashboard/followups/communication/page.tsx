...
export default async function CommunicationPage({ params, searchParams }: {
  ...
  return <CommunicationWorkSelectionProvider key={sessionKey}><FollowupQueryMemory keys={["scope", "pageSize"]} /><DashboardPage title={workspaceT("communication")} density="compact" bodyClassName="gap-1.5" commandPanel={<FollowupCommandPanel>
