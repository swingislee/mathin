...
import { PROFILE_REVIEW_ENABLED } from '@/features/school/profile-review-contract';

export const metadata = { robots: { index: false, follow: false } };

export default async function ProfileReviewPage({ params }: { params: Promise<{ locale: string }> }) {
  if (!PROFILE_REVIEW_ENABLED || !isLocalHistoryArchiveEnvironment(process.env.NODE_ENV, process.env.NEXT_PUBLIC_SUPABASE_URL)) notFound();
