...
async function CourseFamilyProductPage({
  ...
  if (!family) permanentRedirect(familyHref(detail.family.id, detail.selectedVariant.id));
  ...
  const baseHref = familyHref(detail.family.id, detail.selectedVariant.id);
  ...
  return <>
    ...
    <TeachingPlan detail={detail} canManage={canManage} />
