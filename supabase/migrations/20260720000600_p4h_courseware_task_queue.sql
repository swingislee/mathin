...
create function public.list_courseware_tasks(
...
revoke all on function public.list_courseware_tasks(text, text, integer) from public, anon, authenticated;
grant execute on function public.list_courseware_tasks(text, text, integer) to authenticated;
