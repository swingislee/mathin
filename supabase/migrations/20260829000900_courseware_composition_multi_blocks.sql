-- Let the finite 12x9 grid, rather than an arbitrary product cap, limit block count.
-- Game instances are independently keyed and may coexist with H5, source and node blocks.
...
comment on function public.cw_courseware_composition_doc_is_valid(jsonb)
  is 'Structural hard gate for non-overlapping courseware-composition-v1 blocks; the 12x9 grid is the capacity limit and game/H5 instances may coexist.';
