-- DATA-IMPORT-CLASS-ROSTER-4: every newly provisioned Mofaxiao E-series
-- class uses the 科学思维 series label. The display name uses the explicit
-- uppercase teacher initials supplied by the versioned importer while the
-- full teacher name remains available for staff-profile resolution.
