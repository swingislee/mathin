...
export default defineConfig({
  ...
  projects: [
    ...
    ...(target.releaseMode ? [] : [{
      ...
      testMatch: ["r1-live-golden-path.spec.ts", "teacher-microcourse.spec.ts", "organization-location-settings.spec.ts", "staff-self-role.spec.ts", "staff-overview.spec.ts", "assessment-unified-workbench.spec.ts"],
      use: {
        ...devices["Desktop Chrome"],
        trace: "off" as const,
